...
class CreateTblBookMasterCategoryTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tbl_book_master_category', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('tbl_book_master_category');
    }
}
