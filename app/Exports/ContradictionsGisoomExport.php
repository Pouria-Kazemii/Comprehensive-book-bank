...
class ContradictionsGisoomExport implements FromCollection,WithHeadings
{
    ...
    public function collection()
    {
        ...
        $report = BookGisoom::select('recordNumber','title','nasher','tedadSafe','saleNashr','shabak','ghatechap','check_status','cat','has_permit','images')->where('title','!=',NULL)->whereIN('has_permit',  $status)->whereIN('check_status',$status)->get();
    ...
    {
        return ["آیدی کتاب در گیسوم", "عنوان کتاب","ناشر","تعداد صفحه","سال نشر","شابک","قطع","وضعیت در خانه کتاب","راهنمای خانه کتاب","وضعیت در اداره کتاب","راهنمای اداره کتاب"];
    }
}
