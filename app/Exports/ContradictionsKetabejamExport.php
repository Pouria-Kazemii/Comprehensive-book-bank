...
class ContradictionsKetabejamExport implements FromCollection,WithHeadings
{
    ...
    public function collection()
    {
        ...
        $report = BookKetabejam::select('pageUrl','title','nasher','tedadSafe','shabak','ghatechap','check_status','cats','has_permit','images')->where('title','!=',NULL)->whereIN('has_permit',  $status)->whereIN('check_status',$status)->get();
    ...
    {
        return ["آیدی کتاب در کتاب جم", "عنوان کتاب","ناشر","تعداد صفحه","شابک","قطع","وضعیت در خانه کتاب","راهنمای خانه کتاب","وضعیت در اداره کتاب","راهنمای اداره کتاب"];
    }
}
