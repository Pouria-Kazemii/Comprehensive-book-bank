...
class BookFirstCoverNumberAverageDataAccordingToDioCodesForAllTimesJob implements ShouldQueue
{
            ...
            return $collection->aggregate([
                ...
                [
                    '$group' => [
                        ...
                        'average' => ['$sum' => '$first_cover_average'] ,
                        'count' => ['$sum' => 1]
                    ]
                ]
            ]);
        ...
        if ($data != null){
            foreach ($data as $value){
                BookDioCachedData::updateOrCreate(
                    ...
                    ,
                    [
                        'first_cover_average' => round($value['average'] / $value['count'])
                    ]
                );
            }
        }
