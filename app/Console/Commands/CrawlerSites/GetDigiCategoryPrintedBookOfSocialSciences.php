...
class GetDigiCategoryPrintedBookOfSocialSciences extends Command
{
    /**
    ...
    {
        $search_books_category = 'category-printed-book-of-social-sciences';
        ...
        if (isset($newCrawler)) {
            ...
            while ($pageCounter <= $endC) {
                ...
                try {
                    $pageUrl = 'https://api.digikala.com/v1/categories/printed-book-of-social-sciences/search/?sort=1&page='.$pageCounter;
                    $this->info(" \n ---------- Page URL  " . $pageUrl . "              ------------ ");
