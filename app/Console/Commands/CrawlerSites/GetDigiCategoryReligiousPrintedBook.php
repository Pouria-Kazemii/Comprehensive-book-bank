...
class GetDigiCategoryReligiousPrintedBook extends Command
{
    /**
    ...
    {
        $search_books_category = 'category-religious-printed-book';
        ...
        if (isset($newCrawler)) {
            ...
            while ($pageCounter <= $endC) {
                ...
                try {
                    $pageUrl = 'https://api.digikala.com/v1/categories/religious-printed-book/search/?sort=1&page='.$pageCounter;
                    $this->info(" \n ---------- Page URL  " . $pageUrl . "              ------------ ");
