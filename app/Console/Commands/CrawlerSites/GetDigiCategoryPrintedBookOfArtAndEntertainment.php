...
class GetDigiCategoryPrintedBookOfArtAndEntertainment extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'get:digiCategoryPrintedBookOfArtAndEntertainment {crawlerId}';
    ...
    {
        $search_books_category = 'category-printed-book-of-art-and-entertainment';
        ...
        if (isset($newCrawler)) {
            ...
            while ($pageCounter <= $endC) {
                ...
                try {
                    $pageUrl = 'https://api.digikala.com/v1/categories/printed-book-of-art-and-entertainment/search/?sort=1&page='.$pageCounter;
                    $this->info(" \n ---------- Page URL  " . $pageUrl . "              ------------ ");
