...
class GetTaaghchePeriodicReportedDefects extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'get:taaghchePeriodicReportedDefects {crawlerId}';
     ...
     * @var string
     */
    protected $description = 'Get taghche Book Command';
