...
class GetDigiCategoryForeignPrintedBook extends Command
{
    /**
    ...
    {
        $search_books_category = 'category-foreign-printed-book';
        ...
        if (isset($newCrawler)) {
            ...
            while ($pageCounter <= $endC) {
                ...
                try {
                    $pageUrl = 'https://api.digikala.com/v1/categories/foreign-printed-book/search/?sort=1&page='.$pageCounter;
                    $this->info(" \n ---------- Page URL  " . $pageUrl . "              ------------ ");
