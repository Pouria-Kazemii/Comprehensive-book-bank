...
class GetDigiCategoryPrintedBookOfPhilosophyAndPsychology extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'get:digiCategoryPrintedBookOfPhilosophyAndPsychology {crawlerId}';
    ...
    {
        $search_books_category = 'category-printed-book-of-philosophy-and-psychology';
        ...
        if (isset($newCrawler)) {
            ...
            while ($pageCounter <= $endC) {
                ...
                try {
                    $pageUrl = 'https://api.digikala.com/v1/categories/printed-book-of-philosophy-and-psychology/search/?sort=1&page='.$pageCounter;
                    $this->info(" \n ---------- Page URL  " . $pageUrl . "              ------------ ");
