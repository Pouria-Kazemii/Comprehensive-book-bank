...
class GetDigiCategoryTextbookTutorialsAndTests extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'get:digiCategoryTextbookTutorialsAndTests {crawlerId}';
    ...
    {
        $search_books_category = 'category-textbook-tutorials-and-tests';
        ...
        if (isset($newCrawler)) {
            ...
            while ($pageCounter <= $endC) {
                ...
                try {
                    $pageUrl = 'https://api.digikala.com/v1/categories/textbook-tutorials-and-tests/search/?sort=1&page='.$pageCounter;
                    $this->info(" \n ---------- Page URL  " . $pageUrl . "              ------------ ");
