...
class GetDigiCategoryPrintedHistoryAndGeographyBook extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'get:digiCategoryPrintedHistoryAndGeographyBook {crawlerId}';
    ...
    {
        $search_books_category = 'category-printed-history-and-geography-book';
