...
class GetDigiCategoryLanguageBooks extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'get:digiCategoryLanguageBooks {crawlerId}';
    ...
    {
        $search_books_category = 'category-language-books';
        ...
        if (isset($newCrawler)) {
            ...
            while ($pageCounter <= $endC) {
                ...
                try {
                    $pageUrl = 'https://api.digikala.com/v1/categories/language-books/search/?sort=1&page='.$pageCounter;
                    $this->info(" \n ---------- Page URL  " . $pageUrl . "              ---------=-- ");
