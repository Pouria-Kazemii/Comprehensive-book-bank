...
class UpdateBookMasterIdKetabrah extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'update:book_master_id_ketabrah {limit}';
    ...
    public function handle()
    {
        ...
        $books = BookKetabrah::where('book_master_id', 0)->where('shabak', '!=', null)->skip(0)->take($limit)->get();
        if ($books->count() != 0) {
