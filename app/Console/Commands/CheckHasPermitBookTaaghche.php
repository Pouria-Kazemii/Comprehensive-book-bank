...
class CheckHasPermitBookTaaghche extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'CheckHasPermitBookTaaghche {limit}';
     ...
     * @var string
     */
    protected $description = 'check book taaghche isbn with ershad book and ketab.ir';
    ...
    public function handle()
    {
        ...
        $books = BookTaaghche::where('has_permit',0)->skip(0)->take($limit)->get();
        if($books->count() != 0){
