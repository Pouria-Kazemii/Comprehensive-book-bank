...
class CheckHasPermitBookFidibo extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'CheckHasPermitBookFidibo {limit}';
     ...
     * @var string
     */
    protected $description = 'check book fidibo isbn with ershad book and ketab.ir';
    ...
    public function handle()
    {
        ...
        $books = BookFidibo::where('has_permit',0)->skip(0)->take($limit)->get();
        if($books->count() != 0){
