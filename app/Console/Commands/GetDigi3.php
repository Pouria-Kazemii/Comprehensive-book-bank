...
class GetDigi3 extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'get:digiCategoryAppliedSciencesTechnologyAndEngineering {crawlerId} {miss?}';
    ...
    public function handle()
    {
        ...
        if (isset($newCrawler)) {
            ...
            while ($recordNumber <= $endC) {
                ...
                $bar->start();
                try {
                    $pageUrl = 'https://www.digikala.com/ajax/search/category-applied-sciences-technology-and-engineering/?pageno=' . $recordNumber . '&sortby=1';
                    $this->info(" \n ---------- Page URL  " . $pageUrl . "              ---------=-- ");
